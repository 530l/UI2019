...
public class ClientActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createTestSingleView() {
        TextView item = (TextView) getLayoutInflater().inflate(R.layout.item_view_tv, testViewGroup, false);
        item.setText("530");
        testViewGroup.addView(item);
    }
    ...
    private void createSingleView() {
        ...
        TextView item = (TextView) getLayoutInflater().inflate(R.layout.item_single_tag, tagFlowLayout, false);
        item.setText(itemContent);
        item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ClientActivity.this, "text:" + itemContent, Toast.LENGTH_SHORT).show();
            }
        });
